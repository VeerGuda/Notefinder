...
def get_document_summary():
    if st.session_state.conversation:
        user_question = "Provide a summary of the document."
...
def get_document_questions():
    if st.session_state.conversation:
        user_question = "Generate a list of detailed questions IN QUESTION FORMAT for the user to practice about the uploaded document."
...
def main():
    ...
    with col1:
        st.title("NoteFinder")
    with col2:
        st.image("C:\Users\veerg\logovs2.png", width = 80)
    ...
    with st.sidebar:
        st.image("C:\Users\veerg\logovs2.png", width = 200)
